...
const BOTS_KEY = 'echat_bots';
const botMessagesKey = (botId: string, userId: string) => `echat_bot_messages_${botId}_${userId}`;
...
const DEFAULT_BOTS: Omit<Bot, 'id' | 'createdAt' | 'avatarColor'>[] = [
  {
    ...
    commands: [
      ...
      { command: '/about', description: 'About this bot', response: 'Helper Bot is a built-in assistant that helps you navigate and use Echat effectively. I can answer questions about features and guide you through the app.' },
    ],
  },
  {
    name: 'Reminder Bot',
